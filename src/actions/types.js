...
export const LESSON_GET_BY_ID_INITIATED = 'LESSON_GET_BY_ID_INITIATED';
export const LESSON_FOR_TEACHER_GET_BY_ID = 'LESSON_FOR_TEACHER_GET_BY_ID';
export const LESSON_FOR_TEACHER_UPDATE_SAT_BASE = 'LESSON_FOR_TEACHER_UPDATE_SAT_BASE';
export const LESSON_FOR_TEACHER_UPDATE_AQ_BASE = 'LESSON_FOR_TEACHER_UPDATE_AQ_BASE';
...
export const COURSES_GET_BY_IDS = 'COURSES_GET_BY_IDS';
export const COURSES_GET_BY_IDS_INITIATED = 'COURSES_GET_BY_IDS_INITIATED';
...
export const COURSE_ONGOING_GET_COURSE_BY_CO_ID = 'COURSE_ONGOING_GET_COURSE_BY_CO_ID';
export const COURSE_ONGOING_GET_EXTENDED_COURSE_BY_CO_ID = 'COURSE_ONGOING_GET_EXTENDED_COURSE_BY_CO_ID';
export const COURSE_ONGOING_UPDATE_COMPLETION_POINTS_OF_EXTENDED_COURSE_BY_CO_ID = 'COURSE_ONGOING_UPDATE_COMPLETION_POINTS_OF_EXTENDED_COURSE_BY_CO_ID';
...
export const GET_SAT_EXERCISES_INITIATE = 'GET_SAT_EXERCISES_INITIATE';

// Audio exercise types
export const GET_AUDIO_EXERCISES_BY_LESSON_ID = 'GET_AUDIO_EXERCISES_BY_LESSON_ID';
export const CREATE_MANY_AUDIO_EXERCISES = 'CREATE_MANY_AUDIO_EXERCISES';
export const GET_AUDIO_EXERCISES_INITIATE = 'GET_AUDIO_EXERCISES_INITIATE';