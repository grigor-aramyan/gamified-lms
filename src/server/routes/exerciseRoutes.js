...
// @route POST api/exercises/singleAnswerTestQuestion/updateLessonSatBase
// @desc Delete exercises with provided ids and create new exercises from provided json objects
// @access Private
router.post('/singleAnswerTestQuestion/updateLessonSatBase', auth, function(req, res) {
    ...
    if (tmpLessonId) {
        Lesson.findById(tmpLessonId, (err, l) => {
            ...
            SingleAnswerTestExercise.deleteMany({ _id: { $in: exercisesToDelete } }, (err) => {
                ...
                SingleAnswerTestExercise.collection.insertMany(exercisesMapped, (err, satExercises) => {
                    ...
                    SingleAnswerTestExercise.find({ lessonId: tmpLessonId }, (err2, exercises2) => {
        ...
        try {
            ...
            SingleAnswerTestExercise.findById(tmpQuestionId.toString(), (err, s) => {
                ...
                try {
                    ...
                    Lesson.findById(tmpLessId.toString(), (err, l) => {
                        ...
                        SingleAnswerTestExercise.deleteMany({ _id: { $in: exercisesToDelete } }, (err) => {
                            ...
                            SingleAnswerTestExercise.find({ lessonId: tmpLessId }, (err2, exercises2) => {
                                if (err2 || (exercises2 == null)) return res.status(400).json({ msg: 'No exercises found for this lesson!' });
